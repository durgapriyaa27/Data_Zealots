...
import com.example.mycontactlistapp.DatePickerDialog.SaveDateListener;
...
public class ContactActivity extends FragmentActivity implements SaveDateListener {
	...
	private void changeBackgroundColor() {
	    ...
	    String color = getSharedPreferences("MyContactListPreferences", Context.MODE_PRIVATE).getString("backgrdColor", "white");
	    ScrollView scview = (ScrollView) findViewById(R.id.scrollView1);

	    if(color.equalsIgnoreCase("background1"))
	    {
	        scview.setBackgroundColor(getResources().getColor(R.color.background1));
	    }
	    else if(color.equalsIgnoreCase("background2"))
	    {
	        scview.setBackgroundColor(getResources().getColor(R.color.background2));
	    }
	    else if(color.equalsIgnoreCase("background3"))
	    {
	        scview.setBackgroundColor(getResources().getColor(R.color.background3));
	    }
	}
